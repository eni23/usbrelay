...
static const PROGMEM char configDescrCDC[] = {   /* USB configuration descriptor */
    ...
    (char) USBDESCR_CONFIG,    /* descriptor type */
    67,
    ...
    (1 << 7) | (char) USBATTR_SELFPOWER,       /* attributes */
#else
    (char) (1 << 7),                           /* attributes */
#endif
    ...
    (char) USBDESCR_INTERFACE, /* descriptor type */
    0,          /* index of this interface */
    0,          /* alternate setting for this interface */
    (char) USB_CFG_HAVE_INTRIN_ENDPOINT,   /* endpoints excl 0: number of endpoint descriptors to follow */
    (char) USB_CFG_INTERFACE_CLASS,
    (char) USB_CFG_INTERFACE_SUBCLASS,
    (char) USB_CFG_INTERFACE_PROTOCOL,
    0,          /* string index for interface */

    /* CDC Class-Specific descriptor */
    5,           /* sizeof(usbDescrCDC_HeaderFn): length of descriptor in bytes */
    (char) 0x24,        /* descriptor type */
    ...
    (char) 0x02,        /* SET_LINE_CODING, GET_LINE_CODING, SET_CONTROL_LINE_STATE    */
    ...
    (char) USBDESCR_ENDPOINT,  /* descriptor type = endpoint */
    (char) 0x80|(char) USB_CFG_EP3_NUMBER,        /* IN endpoint number 3 */
    (char) 0x03,        /* attrib: Interrupt endpoint */
    8, 0,        /* maximum packet size */
    (char) USB_CFG_INTR_POLL_INTERVAL,        /* in ms */
    ...
    (char) 0x0A,        /* Data Interface Class Codes */
    0,
    ...
    (char) 0x02,        /* attrib: Bulk endpoint */
    (char) HW_CDC_BULK_OUT_SIZE, 0,        /* maximum packet size */
    0,           /* in ms */
    ...
    (char) 0x02,        /* attrib: Bulk endpoint */
    (char) HW_CDC_BULK_IN_SIZE, 0,        /* maximum packet size */
    0,           /* in ms */
};
